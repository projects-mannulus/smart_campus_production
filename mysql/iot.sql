...
-- usuario administrador para la aplicacion
-- username: admin
-- password: admin
INSERT INTO iot.app_user
(username, password, email, id_user, name, is_admin)
VALUES('admin', '$2a$10$do.JHaCqpcGqPnH4A3prFO3GRPdQy7akfNcKTeKi7f/3QzSKHmE5O', 'admin@example.com', 1, 'name admin', 0);
